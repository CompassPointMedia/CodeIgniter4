 ...
 * @return string
 */
if(!function_exists('get_client_url')){
...
if(!function_exists('get_client_page')){
...
if(!function_exists('get_page_from_uri')){
...
if(!function_exists('set_app_env')){
...
if(!function_exists('date_time_component')){
